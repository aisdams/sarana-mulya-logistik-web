...
export default function Navbar({ isScrolled }: NavbarProps) {
  ...
  return (
    <div
      className={`w-full absolute top-0 lg:grid ${
        isScrolled
          ? 'bg-white sticky text-base-blue shadow-[-5px_10px_30px_0px_rgba(0,0,0,0.5)] transition-all duration-300'
          : 'bg-transparent sticky text-white'
      } z-10`}
    >
